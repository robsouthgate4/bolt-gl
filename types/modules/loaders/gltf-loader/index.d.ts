...
export default class GLTFLoader {
    private _accessorSize;
    private _typedArrayMap;
    private _path;
    private _materials;
    private _textures;
    private _scene;
    ...
    _parseDrawSet(gltf: GlTf, mesh: GLTFMesh, buffers: ArrayBufferLike[], index: number): (DrawSet | undefined)[];
    _parseMaterials(gltf: GlTf, material: Material, index: number): Program;
    _parseTexture(gltf: GlTf, texture: GLTFTexture): Promise<Texture2D>;
    /**
     * @param  {string} path
     * @param  {BufferView} buffer
     * Returns buffers from either a .bin file or the binary property from .glb
     */
    _fetchBuffer(path: string, buffer: BufferView): Promise<any>;
    _getBufferFromFile(gltf: GlTf, buffers: ArrayBuffer[], accessor: Accessor): Buffer;
    _getBufferByAttribute(gltf: GlTf, buffers: ArrayBuffer[], mesh: GLTFMesh, primitive: MeshPrimitive, attributeName: string): Buffer | undefined;
    _getAccessor: (gltf: GlTf, mesh: GLTFMesh, primitive: MeshPrimitive, attributeName: string) => Accessor;
    _decodeGLB(glb: ArrayBufferLike): any;
    _decodeGeometry(draco: any, decoder: any, decoderBuffer: any, gltfDracoAttributes: any, gltf: any, primitive: any): {
        index: null;
        attributes: {};
    };
    _getDracoArrayTypeFromComponentType(componentType: any): string;
    _decodeAttribute(draco: any, decoder: any, dracoGeometry: any, attributeName: any, attribute: any, attributeType: any): {
        name: any;
        array: Int8Array | Uint8Array | Int16Array | Uint16Array | Int32Array | Uint32Array | Float32Array;
        itemSize: any;
        componentType: any;
    };
    get drawSetsFlattened(): DrawSet[];
    set drawSetsFlattened(value: DrawSet[]);
    get animations(): Channel;
}
export {};
